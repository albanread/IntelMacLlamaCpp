...
static const ggml_type base_types[] = {
    ...
    GGML_TYPE_Q4_K,
    GGML_TYPE_Q5_K, GGML_TYPE_Q6_K, GGML_TYPE_Q2_K, GGML_TYPE_Q3_K, // VEGA: cover k-quants at large k
...
// Conv_2D test cases
 ...
 // A deep layer of a ConvNet, several images in the batch
    ...
    test_cases.emplace_back(new test_mul_mat(GGML_TYPE_Q5_K, GGML_TYPE_F32, 4096, 1, 4096, {1, 1}, {1, 1})); // VEGA-REALSHAPE
    test_cases.emplace_back(new test_mul_mat(GGML_TYPE_Q5_K, GGML_TYPE_F32, 4096, 1, 12288, {1, 1}, {1, 1})); // VEGA-REALSHAPE
    test_cases.emplace_back(new test_mul_mat(GGML_TYPE_Q4_K, GGML_TYPE_F32, 4096, 1, 4096, {1, 1}, {1, 1})); // VEGA-REALSHAPE
    test_cases.emplace_back(new test_mul_mat(GGML_TYPE_Q4_K, GGML_TYPE_F32, 4096, 1, 12288, {1, 1}, {1, 1})); // VEGA-REALSHAPE
    test_cases.emplace_back(new test_mul_mat(GGML_TYPE_Q8_0, GGML_TYPE_F32, 4096, 1, 4096, {1, 1}, {1, 1})); // VEGA-REALSHAPE
    ...
    for (ggml_type type_a : base_types) {
        for (ggml_type type_b : {GGML_TYPE_F32, GGML_TYPE_F16}) {
            std::vector<int> ks = { 256, 4096, 12288 }; // 4096/12288 = Qwen3-8B real k (nb=16/48) [VEGA-DEBUG]
