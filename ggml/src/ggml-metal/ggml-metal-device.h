...
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_moe_admit        (ggml_metal_library_t lib);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_moe_resolve      (ggml_metal_library_t lib);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_moe_init         (ggml_metal_library_t lib);
